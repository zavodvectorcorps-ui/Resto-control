...
const roleColor = { manager: "#FF5A00", admin: "#00E676", waiter: "#00E5FF" };
...
export default function Staff() {
  ...
  return (
    <div>
      <PageHead title="Сотрудники" subtitle="Роли и доступ. Официанты и администраторы входят по PIN, менеджеры — по email"
